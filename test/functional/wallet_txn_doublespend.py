...
class TxnMallTest(GamcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 GAM:
        ...
        # First: use raw transaction API to send 1240 GAM to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 GAM coin each
        ...
        # Node0's balance should be starting balance, plus 50GAM for another
        ...
        # Node0's total balance should be starting balance, plus 100GAM for
