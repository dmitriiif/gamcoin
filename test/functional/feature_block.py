...
class FullBlockTest(GamcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure gamcoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure gamcoind isn't accepting b28
        ...
        # gamcoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the gamcoin code has custom code which does so);
