...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/gamcoin/gamcoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(GamcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our gamcoind node")
