...
By default, gamcoind will dump mempool on shutdown and
...
class MempoolPersistTest(GamcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent gamcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
