...
Verify that a gamcoind node can use an external signer command.
...
class RPCSignerTest(GamcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart gamcoind with -signer=<cmd>',
