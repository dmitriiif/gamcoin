...
"""  Tests the mempool:* tracepoint API interface.
     See https://github.com/gamcoin/gamcoin/blob/master/doc/tracing.md#context-mempool
"""
...
class MempoolTracepointTest(GamcoinTestFramework):
    ...
    def rejected_test(self):
        ...
        # https://github.com/gamcoin/gamcoin/issues/27380
