...
"""
Test starting gamcoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(GamcoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that gamcoind has bound on "::1" (for RPC) and "::" (for P2P).
