...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the GamcoinTestFramework
    pass


class ExampleTest(GamcoinTestFramework):
    # Each functional test is a subclass of the GamcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        GamcoinTestFramework class so other tests can use it."""
