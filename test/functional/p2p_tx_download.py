#!/usr/bin/env python3
# Copyright (c) 2019-2021 The Gamcoin Core developers
...
class TxDownloadTest(GamcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new gamcoind instances, as setting mocktimes has long-term effects on when
