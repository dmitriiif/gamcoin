...
class TestShell:
    """Wrapper Class for GamcoinTestFramework.

    The TestShell class extends the GamcoinTestFramework
    ...
    class __TestShell(GamcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by GamcoinTestFramework child class.
            self.num_nodes = 1
