#!/usr/bin/env python3
# Copyright (c) 2021 The Gamcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.

""" Interactive gamcoind P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Gamcoin Core can enable. It uses BCC
...
def main(gamcoind_path):
    ...
    gamcoind_with_usdts.enable_probe(
