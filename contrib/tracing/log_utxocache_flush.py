...
"""Example logging Gamcoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/gamcoind
...
def main(gamcoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[gamcoind_with_usdts])
