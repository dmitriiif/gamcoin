...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef GAMCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define GAMCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the gamcoin network\n')
    ...
    g.write('#endif // GAMCOIN_CHAINPARAMSSEEDS_H\n')
