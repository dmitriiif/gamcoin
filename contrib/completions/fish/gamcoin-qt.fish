...
complete --command gamcoin-qt --no-files

# Extract options
function __fish_gamcoinqt_get_options
...
complete \
    --command gamcoin-qt \
    --arguments "(__fish_gamcoinqt_get_options --nofiles)"
