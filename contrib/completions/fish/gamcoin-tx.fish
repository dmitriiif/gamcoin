...
# Extract options
function __fish_gamcoin_tx_get_options
...
# Extract commands
function __fish_gamcoin_tx_get_commands
...
complete \
    --command gamcoin-tx \
    --condition "not __fish_gamcoin_seen_cmd (__fish_gamcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_gamcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command gamcoin-tx \
    --arguments "(__fish_gamcoin_tx_get_commands)" \
    --no-files
