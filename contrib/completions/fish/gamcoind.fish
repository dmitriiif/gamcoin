...
complete --command gamcoind --no-files

# Extract options
function __fish_gamcoind_get_options
...
complete \
    --command gamcoind \
    --arguments "(__fish_gamcoind_get_options --nofiles)"
