...
(define* (make-gamcoin-cross-toolchain target
                                       #:key
...
desirable for building Gamcoin Core release binaries."
...
;; failure; see https://github.com/gamcoin/gamcoin/pull/27296.
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-gamcoin-cross-toolchain target)))
