...
#ifndef GAMCOIN_NODE_CONNECTION_TYPES_H
#define GAMCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/gamcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Gamcoin’s Peer-to-Peer Network")
...
#endif // GAMCOIN_NODE_CONNECTION_TYPES_H
