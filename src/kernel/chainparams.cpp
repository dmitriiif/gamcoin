...
{
    const char* pszTimestamp = "BBC 13/07/2024 Donald Trump assassination attempt";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 4.2 * 24 * 60 * 60; // two weeks
       ...
       // consensus.defaultAssumeValid = uint256S("0x000000000000000000026811d149d4d261995ec5b3f64f439a0a10e1a464af9a"); // 824000
        ...
        genesis = CreateGenesisBlock(1720696792, 3998537306, 0x1d00ffff, 1, 50 * COIN);
	consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000000933045da8f0e88213a0fa66f2e2e678d3df558d159ec59855fdb8305"));
        assert(genesis.hashMerkleRoot == uint256S("0x6b73dd2173cb7063f253a892c839ac522b7afb0275df7b353cbb02e4ade8f1eb"));
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vSeeds.emplace_back("seed.signet.gamcoin.sprovoost.nl.");
