...
#ifndef GAMCOIN_RPC_UTIL_H
#define GAMCOIN_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting GAM/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1GAM/kvB.
 */
