...
#ifndef GAMCOIN_IPC_CAPNP_COMMON_TYPES_H
#define GAMCOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! Functions to serialize / deserialize common gamcoin types.
namespace mp {
...
#endif // GAMCOIN_IPC_CAPNP_COMMON_TYPES_H
