...
#ifndef GAMCOIN_COMMON_ARGS_H
#define GAMCOIN_COMMON_ARGS_H
...
extern const char * const GAMCOIN_CONF_FILENAME;
extern const char * const GAMCOIN_SETTINGS_FILENAME;
