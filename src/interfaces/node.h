...
#ifndef GAMCOIN_INTERFACES_NODE_H
#define GAMCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a gamcoin node (gamcoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or gamcoin.conf.
...
#endif // GAMCOIN_INTERFACES_NODE_H
