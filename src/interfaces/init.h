...
#ifndef GAMCOIN_INTERFACES_INIT_H
#define GAMCOIN_INTERFACES_INIT_H
...
//! (gamcoin-gui, gamcoin-node, gamcoin-wallet, gamcoind, gamcoin-qt) and each
...
#endif // GAMCOIN_INTERFACES_INIT_H
