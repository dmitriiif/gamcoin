// Copyright (c) 2019-2020 The Gamcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef GAMCOIN_TEST_UTIL_TRANSACTION_UTILS_H
#define GAMCOIN_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // GAMCOIN_TEST_UTIL_TRANSACTION_UTILS_H
