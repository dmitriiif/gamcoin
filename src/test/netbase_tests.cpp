...
{
    BOOST_CHECK(TestSplitHost("www.gamcoincore.org", "www.gamcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.gamcoincore.org]", "www.gamcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.gamcoincore.org:80", "www.gamcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.gamcoincore.org]:80", "www.gamcoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.gamcoincore.org:65536", "www.gamcoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.gamcoincore.org:0", "www.gamcoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.gamcoincore.org:", "www.gamcoincore.org:", 0, false));
}
