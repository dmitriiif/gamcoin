...
#ifndef GAMCOIN_TEST_SCRIPTNUM10_H
#define GAMCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Gamcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // GAMCOIN_TEST_SCRIPTNUM10_H
