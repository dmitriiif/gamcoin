...
#ifndef GAMCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define GAMCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // GAMCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
