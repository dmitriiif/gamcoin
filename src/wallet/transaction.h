...
#ifndef GAMCOIN_WALLET_TRANSACTION_H
#define GAMCOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this gamcoin node, and set to 0 for transactions that were created
...
#endif // GAMCOIN_WALLET_TRANSACTION_H
