...
#ifndef GAMCOIN_WALLET_WALLET_H
#define GAMCOIN_WALLET_WALLET_H
...
public:
     ...
     * gamcoin-wallet tool code or by wallet migration code. If this is called
