...
#ifndef GAMCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define GAMCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Gamcoin Core wallet was originally a collection of unrelated private
...
#endif // GAMCOIN_WALLET_SCRIPTPUBKEYMAN_H
