// Copyright (c) 2017-2021 The Gamcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef GAMCOIN_WALLET_WALLETUTIL_H
#define GAMCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! gamcoin from opening the wallet, thinking it was newly created, and
...
#endif // GAMCOIN_WALLET_WALLETUTIL_H
