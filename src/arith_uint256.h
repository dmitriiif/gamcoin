...
#ifndef GAMCOIN_ARITH_UINT256_H
#define GAMCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Gamcoin only uses this "compact" format for encoding difficulty
