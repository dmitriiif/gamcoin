...
// Copyright 2015 Gamcoin Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef GAMCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
#define GAMCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // GAMCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
