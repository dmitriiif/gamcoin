...
#ifndef GAMCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define GAMCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // GAMCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
