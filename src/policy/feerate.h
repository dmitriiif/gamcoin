...
#ifndef GAMCOIN_POLICY_FEERATE_H
#define GAMCOIN_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "GAM"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    GAM_KVB,      //!< Use GAM/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::GAM_KVB) const;
...
#endif // GAMCOIN_POLICY_FEERATE_H
