// Copyright (c) 2011-2021 The Gamcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef GAMCOIN_QT_GAMCOINUNITS_H
#define GAMCOIN_QT_GAMCOINUNITS_H
...
/** Gamcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GamcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GamcoinUnits(QObject *parent);

    /** Gamcoin units.
      @note Source: https://en.gamcoin.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        GAM,
        mGAM,
