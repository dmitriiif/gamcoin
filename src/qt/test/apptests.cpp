...
//! Entry point for GamcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &GamcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for GamcoinGUI tests.
void AppTests::guiTests(GamcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &GamcoinGUI::consoleShown, this, &AppTests::consoleTests);
