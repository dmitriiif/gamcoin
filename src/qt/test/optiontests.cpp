...
{
    // Test regression https://github.com/gamcoin/gamcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/gamcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/gamcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Gamcoin/Gamcoin-Qt.conf and all else left as default,
    // gamcoin-qt should set both -listen and -listenonion to false and start successfully.
