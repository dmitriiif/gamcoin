...
#ifndef GAMCOIN_QT_OPTIONSMODEL_H
#define GAMCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Gamcoin client.
...
public:
    ...
    GamcoinUnit getDisplayUnit() const { return m_display_gamcoin_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSGAMontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    GamcoinUnit m_display_gamcoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(GamcoinUnit unit);
...
#endif // GAMCOIN_QT_OPTIONSMODEL_H
