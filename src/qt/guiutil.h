...
#ifndef GAMCOIN_QT_GUIUTIL_H
#define GAMCOIN_QT_GUIUTIL_H
...
namespace GUIUtil
{
    ...
    // Parse "gamcoin:" URI into recipient object, return true on successful parsing
