      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->gamcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->gamcoinAtStartup);
    ...
    ui->gamcoinAtStartup->setToolTip(ui->gamcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->gamcoinAtStartup->setText(ui->gamcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openGamcoinConfButton->setToolTip(ui->openGamcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new GamcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->gamcoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSGAMontrols);
...
void OptionsDialog::on_openGamcoinConfButton_clicked()
{
