...
#ifndef GAMCOIN_QT_GAMCOINGUI_H
#define GAMCOIN_QT_GAMCOINGUI_H
...
/**
  Gamcoin GUI main class. This class represents the main window of the Gamcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class GamcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit GamcoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~GamcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a gamcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, GamcoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Gamcoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(GamcoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // GAMCOIN_QT_GAMCOINGUI_H
