Gamcoin Core version 0.9.2.1 is now available from:

  https://gamcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 GAM to 0.01 GAM
...
- Fix "Start gamcoin on system login"
