Gamcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/gamcoin/files/Gamcoin/gamcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Gamcoin
...
New/changed settings (command-line or gamcoin.conf file)
--------------------------------------------------------
