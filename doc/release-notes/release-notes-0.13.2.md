Gamcoin Core version 0.13.2 is now available from:

  <https://gamcoin.org/bin/gamcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update gamcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow gamcoin-tx to create v2 transactions (btcdrak)
