Gamcoin Core version 0.9.4 is now available from:

  https://gamcoin.org/bin/0.9.4/
...
this update is incompatible with the Gamcoin system and could lead to consensus
forks.

Gamcoin Core released binaries from https://gamcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~gamcoin/+archive/ubuntu/gamcoin
- A third-party or self-compiled Gamcoin Core

upgrade to Gamcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
