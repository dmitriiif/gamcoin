Gamcoin Core version *0.15.2* is now available from:

  <https://gamcoincore.org/bin/gamcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in gamcoin-tx (TheBlueMatt)
