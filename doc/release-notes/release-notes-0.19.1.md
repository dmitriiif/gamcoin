...
Gamcoin Core version 0.19.1 is now available from:

  <https://gamcoincore.org/bin/gamcoin-core-0.19.1/>
...
From Gamcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Gamcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Gamcoin Core does not yet change appearance when
...
- #17488 fix "gamcoind already running" warnings on macOS (fanquake)
