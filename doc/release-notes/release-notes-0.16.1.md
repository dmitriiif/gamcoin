Gamcoin Core version 0.16.1 is now available from:

  <https://gamcoincore.org/bin/gamcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting gamcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure gamcoind processes are cleaned up when tests end (sdaftuar)
