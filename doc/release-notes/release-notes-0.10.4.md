Gamcoin Core version 0.10.4 is now available from:

  <https://gamcoin.org/bin/gamcoin-core-0.10.4/>
...
- #6953 `43c2789` Split gamcoin-tx into its own package
- #6953 `dfe0d4d` Include gamcoin-tx binary on Debian/Ubuntu
