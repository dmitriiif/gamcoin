Gamcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/gamcoin/files/Gamcoin/gamcoin-0.5.4/
...
http://gitorious.org/gamcoin/gamcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Gamcoin-Qt notifications under Growl 1.3.
Increase required age of Gamcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxGamcoin properly when installing Gamcoin-Qt over it. (Windows)
