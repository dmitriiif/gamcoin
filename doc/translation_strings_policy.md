...
This document provides guidelines for internationalization of the Gamcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `gamcoin_en.ts` remains unchanged.
