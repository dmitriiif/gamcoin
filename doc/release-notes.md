Gamcoin Core version 27.0 is now available from:

  <https://gamcoincore.org/bin/gamcoin-core-27.0/>
...
using the Linux Kernel 3.17+, macOS 11.0+, and Windows 7 and newer. Gamcoin
...
- libgamcoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libgamcoinkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Gamcoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Gamcoin Core would
